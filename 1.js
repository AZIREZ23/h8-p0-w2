...
// var lahir = prompt("Masukan Tahun Kelahiran: ...");
// var status = prompt ("Isikan: Pelajar atau Non-Pelajar");

// if ( status === pelajar && lahir <= 2) {
//     console.log(nama+" "+lahir+"Harga Tiket Gratis") 
// }
// else if ( status === pelajar && lahir <= 10){
//     function tambahHarga (){
//         var kenaikan = lahir + hargaTik;
//     }
//     console.log(status)
// }
